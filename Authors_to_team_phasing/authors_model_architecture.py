# Auto-extracted model architecture from notebook
# Source: concare-phasing_notebook_base.ipynb
# This file consolidates imports, model classes (nn.Module), and nearby helpers.
